export const translations = {
  en: {
    ...
    // Owner Dashboard
    ownerDashboard: '⏱️ TimeClok Owner',
    overview: 'Overview',
    employees: 'Employees',
    payroll: 'Payroll',
    projects: 'Projects',
    ...
    // Employee Dashboard
    employeeDashboard: '⏱️ TimeClok Employee',
    clockIn: 'Clock In',
    clockOut: 'Clock Out',
    ...
    // Setup
    businessSetup: '⏱️ TimeClok Business Setup',
  ...
  es: {
    ...
    // Owner Dashboard
    ownerDashboard: '⏱️ TimeClok Propietario',
    overview: 'Resumen',
    employees: 'Empleados',
    payroll: 'Nómina',
    projects: 'Proyectos',
    ...
    // Employee Dashboard
    employeeDashboard: '⏱️ TimeClok Empleado',
    ...
    // Setup
    businessSetup: '⏱️ Configuración de Negocio TimeClok',
    adminToken: 'Token de Administrador',
    ownerName: 'Nombre del Propietario',
    createBusinessAccount: 'Crear Cuenta de Negocio',
